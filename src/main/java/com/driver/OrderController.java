...
public class OrderController {
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        ...
        orderService.addDeliveyPartner(partnerId);
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        ...
        orderService.addPair(orderId,partnerId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = orderService.getDeliveryParnterById(partnerId);
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.getCountForLeftOrdersLeftAfterTime(time,partnerId);
